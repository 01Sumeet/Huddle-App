                ...
                <Form className="main-container" style={{ color: "white" }}>
                    <div className="container">
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center' }}>
                                <div className="input-filed">
                                    ...
                                    <div className="input-error">
                                        <ErrorMessage component="small" className="error" name="firstName" />
                                    </div>
                                </div>
                                <div className="input-filed">
                                    <InputField
                                    ...
                                    />
                                    <div className="input-error">
                                        <ErrorMessage className="error" name="lastName" component="small" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="forget">
                            <p>
                                Already had an account..?<Link className='sign-up' to='/login'> Log In</Link>
                            </p>
                        </div>
